...
- A diagonal, uneven staircase runs from the upper-left area toward the lower-right area,
  visually separating a lower-left triangle from an upper-right triangle.
- The upper-right triangle contains Trello-style overlapping note cards that explain the
  project idea.
- The lower-left triangle contains a Trello-style product note and the product CTA.
