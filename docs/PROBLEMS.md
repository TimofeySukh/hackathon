...
- Notes: needs product requirements for public messaging, target audience, routing, auth entry points, and how the landing page coexists with the board-first app. The board now has a lightweight onboarding overlay for empty or starter-sized graphs, but this is not a public landing page.
