...
- circular pie-zone group rendering with proportional category slices and thin orbit guides
...
- blob groups render as circular pie zones whose slices follow merged member categories and arrange members inside their slice
