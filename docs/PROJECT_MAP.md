...
- the `nested-rings` glass top-bar interface, including light/dark theme switching, a LinkedIn ZIP import shortcut, zoom/reset controls, settings, and a bottom-right zoom indicator
