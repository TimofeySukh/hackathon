...
2. double-click or double-tap the board to create new people
3. drag people close together to form readable blob groups
...
2. Fast double-click and double-tap node creation
