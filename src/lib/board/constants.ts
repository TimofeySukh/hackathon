...
// Above this many board nodes, pointer-driven resize must avoid the global
// O(n^2) collision relaxer. The resize path keeps containment local instead.
export const RESIZE_COLLISION_LIMIT = 1500
