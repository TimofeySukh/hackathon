...
const CONNECTIONS = [
  ...
  { from: 'you', to: 'vcs', color: '#3b82f6' },
  { from: 'you', to: 'partners', color: '#ec4899' },
  { from: 'you', to: 'leads', color: '#f59e0b' },
  { from: 'team', to: 'leads', color: 'rgba(255,255,255,0.1)' },
  { from: 'partners', to: 'vcs', color: 'rgba(255,255,255,0.1)' },
]
